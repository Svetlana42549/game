...
apple1= Food("яблоко.png", 200, 0)  # создание объекта класса Food
apple2 = Food("яблоко.png", 450, 0)  # создание объекта класса Food
apple3 = Food("яблоко.png", 650, 0)  # создание объекта класса Food
apple4 = Food("яблоко.png", 850, 0)  # создание объекта класса Food
apple5 = Food("яблоко.png", 50, 0)  # создание объекта класса Food
